...
export class TransactionsRepository {
    ...
    async getBalance({ beginDate, endDate }: GetDdashBoardTDO): Promise<Balance> {
    ...
    async getExpenses({beginDate, endDate}: GetDdashBoardTDO): Promise<Expense[]>{
    ...
    async getFinanciaEvolution(year: getFinanciaEvolutionDTO): Promise<Balance[]> {
        const aggregate = this.model.aggregate<Balance>();
